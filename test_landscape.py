...
landscape_component = """
// --- Landscape Contact Screen Component (Split Screen Horizontal Effect) ---
...
# Find where to insert it. Let's insert it before PortraitContactScreen.
idx = content.find('// --- Portrait Contact Screen Component')
content = content[:idx] + landscape_component + '\n' + content[idx:]
